...
if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
	t[#t+1] = Def.ActorFrame {
		LoadActor("Grade_AAAA_Tier")..{
			InitCommand=cmd(x,SCREEN_CENTER_X-161;y,SCREEN_CENTER_Y-6;zoom,0);
...
if GAMESTATE:IsPlayerEnabled(PLAYER_2) then
	t[#t+1] = Def.ActorFrame {
		LoadActor("Grade_AAAA_Tier")..{
			InitCommand=cmd(x,SCREEN_CENTER_X+227;y,SCREEN_CENTER_Y-6;zoom,0);
			OnCommand=function(self)
